...
<jsp>
    <head lang="vi" xml:lang="vi">
        ...
        <meta property="og:url" content="honda-hrv-g-1410105.jsp" />
        ...
        <link rel="canonical" href="honda-hrv-g-1410105.jsp" />
        <script type="application/ld+json">
            {
                ...
                "offers": {
                    "@type": "Offer",
                    "url": "https://hondaotolongbienhn.com/honda-hrv-g-1410105.jsp",
                    "priceCurrency": "VND",
                    "price": "699000000",
        ...
        <script>
            $(document).ready(function() {
                ...
                $('input[data-field="quantity"]').on('input', function() {
                    // Lấy giá sản phẩm
                    var price = parseFloat($('#form-product').data('value'));
                    // Lấy số lượng sản phẩm người dùng đã nhập
                    var quantity = parseInt($(this).val());
                    // Tính tổng tiền
                    var total = price * quantity;
                    // Hiển thị tổng tiền
                    $('span[data-field="totalPrice"]').text(total.toLocaleString('vi-VN') + ' đ');
                });
            });
        </script>
                ...
                <div class="primary-product group">
                    <div class="image-block group slider-product">
                        <div class="owl-carousel owl-theme owl-gallery-images">
                            <c:forEach  var="colorCar" items="${listColor}">
                                <div class="item">
                                    <a data-fancybox="gallery" data-caption="Honda HR-V G" title="Honda HR-V G" href="${colorCar.colorImg}">
                                        <img alt="${colorCar.colorName}" class="lazyload" data-src="${colorCar.colorImg}" />
                                    </a>
                                </div>
                            </c:forEach>
                        </div>
                        <div class="owl-carousel owl-theme owl-gallery-thumbs">
                            <c:forEach  var="colorCar" items="${listColor}">
                                <div class="item"><img class="img-fullwidth lazyload" alt="${colorCar.colorName}" data-src="${colorCar.colorImg}" /></div>
                            </c:forEach>
                        </div>
                    </div>
                    ...
                    <span class="rating-box">
                        ...
                        <div class="social-sharing" data-title="Honda HR-V G" data-url="honda-hrv-g-1410105.jsp">
                        ...
                        <div class="product-buy" id="form-product" data-id="1410105" data-value="699000000" data-url="gio-hang.jsp">
                            <p class="product-row">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tabC01">
                            <div class="detail-content">
                                <c:forEach  var="attribute" items="${listAttr}">
                                    <h2 class="heading-3">${attribute.attributeName}</h2>

                                    <p>${attribute.attributeValue}</p>

                                    <p style="text-align: center;"><img  alt="" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="lazyload" data-src="${attribute.attributeImg}"/></p>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
