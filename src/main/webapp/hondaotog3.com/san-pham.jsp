            ...
            <div class="banner-inner">
                <div class="logo">
                    <a title="" href="index.jsp"><img class="img-logo lazyload" alt=""
                                                      data-src="../drive.gianhangvn.com/image/banner-top-2660267j31185.jpg"/></a>
                </div>
                <div class="banner">
        ...
        <div class="container">
            ...
            <ol class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <a title="Trang chủ" itemtype="https://schema.org/Thing" itemprop="item"
                       href="LoadAutomaker?load=home"><span itemprop="name"><span
                            ...
                            <div class="vertical-menu phone-vertical-menu">
                                <c:forEach var="categoryCar" items="${listAutomaker}">
                                    <ul class="primary-menu">
                                        <li>
                                            <a href="ProductSeverlet?id=${categoryCar.automaker_id}"
                                               title="Honda City">${categoryCar.automaker_name}</a>
                                        </li>
                                    </ul>
                                </c:forEach>
                            </div>
                            ...
                            <div class="block group">
                                <div class="block-img block-img-border">
                                    <a href="honda-accord-1-5l-turbo-1287636.jsp" title="Honda Accord 1.5L Turbo"><img
                                            class="img-default lazyload" alt="Honda Accord 1.5L Turbo"
                                            data-src="../drive.gianhangvn.com/image/honda-accord-1-5l-turbo-1855972j31185x16.jpg"/></a>
                                </div>
                                <div class="block-caption">
                                    <h5 class="block-title"><a href="honda-accord-1-5l-turbo-1287636.jsp"
                                                               title="Honda Accord 1.5L Turbo">Honda Accord 1.5L
                                        Turbo</a></h5>
                        ...
                        <div class="box-left-content collapse-content">
                            <ul class="list-group statistic">
                                ...
                                <li id="statistic-yesterday">
                                    <span class="statistic-text yesterday"
                                          data-lang="md_statistic_yesterday">Hôm qua</span>
                                    ...
                                    <div class="col-6 col-md-4 col-product">
                                        <div class="product">
                                            <div class="product-image">
                                                <a href="loa" title="Honda Accord 1.5L Turbo"><img
                                                        class="img-responsive lazyload" alt="Honda Accord 1.5L Turbo"
                                                        data-src="${listProductByID.linkVideo}"/></a>
                                            </div>
                                            <div class="caption">
                                                <h3 class="name"><a href="#"
                                                                    title="Honda Accord 1.5L Turbo">${listProductByID.productName}</a>
                                                </h3>
                                                ...
                                                <a class="btn btn-addcart" href="#" data-id="1287636"
                                                   data-url="https://hondaotolongbienhn.com/gio-hang.jsp"
                                                   title="Mua ngay" data-lang="btn_addcart">THÊM VÀO GIỎ HÀNG</a>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
                            ...
                            <div class="pagination-container">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <c:if test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="ProductSeverlet?id=${currentId}&page=${currentPage - 1}&sortItem=${sortItem}"
                                               aria-label="Previous">
                                    ...
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <li class="page-item <c:if test='${i == currentPage}'>active</c:if>">
                                            <a class="page-link"
                                               href="ProductSeverlet?id=${currentId}&page=${i}&sortItem=${sortItem}">${i}</a>
                                        </li>
                                    </c:forEach>
                        ...
                        <div class="col col_6 footer-block">
                            ...
                            <div class="google-map">
                                <iframe allowfullscreen="" height="250" loading="lazy"
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.943942542734!2d105.90214521398168!3d21.034928885995026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abc4ff1eab73%3A0xf98f380b5efd9ccd!2zSG9uZGEgw5QgdMO0IExvbmcgQmnDqm4!5e0!3m2!1svi!2s!4v1626252246292!5m2!1svi!2s"
