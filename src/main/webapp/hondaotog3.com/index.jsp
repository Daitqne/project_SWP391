                            ...
                            <div class="product">
                                <div class="product-image">
                                    <a href="honda-civic-1-5rs-1352399.jsp" title=${listTop4Civicc.productName}><img
                                            ...
                                            data-src=${listTop4Civicc.attributeImg}/></a>
                                </div>
                                <div class="caption">
                                    <h3 class="name"><a href="honda-civic-1-5rs-1352399.jsp" title="Honda Civic RS">${listTop4Civicc.productName}</a></h3>
...
<<<<<<< HEAD
                                <c:forEach items="${listTop4HRV}" var="listTop4HRV">
                                    <div class="col-6 col-md-3 col-product">
                                        ...
                                        <div class="product">
                                            <div class="product-image">
                                                <a href="#" title=${listTop4HRV.productName}><img
                                                        class="img-responsive lazyload" alt="Honda Civic RS"
                                                        data-src=${listTop4HRV.attributeImg}/></a>
                                            </div>
                                            <div class="caption">
                                                <h3 class="name"><a href="#" title="Honda Civic RS">${listTop4HRV.productName}</a></h3>
                                                <div class="content-price">
                                                    <span class="price">${listTop4HRV.price}</span>
                                                    <span class="view"><i class="fa fa-eye"></i><span>2,874 lượt</span></span>
                                                </div>
                                                <a class="btn btn-addcart" href="#" data-id="1352399"
                                                   data-url="#" title="Mua ngay"
